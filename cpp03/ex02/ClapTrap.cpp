...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/29 15:21:10 by gabastos          #+#    #+#             */
/*   Updated: 2025/04/29 15:21:11 by gabastos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap() : _name("Cristiano Ronaldo"), _hitPoints(10),
_energyPoints(10), _attackDamage(0)
{
	std::cout << RED << "ClapTrap default constructor has been called." << std::endl;
}
